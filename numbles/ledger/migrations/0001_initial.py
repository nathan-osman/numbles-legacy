...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ledger_total', (
            ...
            ('balance', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=9, decimal_places=2)),
        ))
    ...
    models = {
        ...
        u'ledger.account': {
            ...
            'balance': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '9', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
